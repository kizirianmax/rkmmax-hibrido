...
| Item | Detalhe |
|------|---------|
| **Título do PR** | `docs(construtor): registrar coleta diagnóstica pós-contrato estático` |
...
| **Comparação explícita com a baseline do PR #600** | **#600 (runtime real manual):** `0 eligible / 10 unavailable`, `byReason={"entrypoint-nao-permitido":6,"dependencias-externas-nao-permitidas":1,"multifile-body-vazio":1,"arquivo-fora-da-allowlist":2}`. **Pós-#602 neste CI:** evidência determinística positiva para estáticos (`stage: "static-contract"`), mas **sem nova amostragem runtime real de 10 casos**. |
