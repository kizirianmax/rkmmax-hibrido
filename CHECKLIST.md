...
| **Arquivos alterados** | `src/lib/construtor/constructorStaticClientArtifactContract.js`; `src/lib/construtor/constructorApprovedPreviewDiagnosticReader.js`; `src/lib/construtor/__tests__/constructorStaticClientArtifactContract.test.js`; `src/lib/construtor/__tests__/constructorApprovedPreviewDiagnosticReader.test.js`; `CHECKLIST.md`. |
...
| **Validações executadas** | `npm test -- --runInBand src/lib/construtor/__tests__/constructorStaticClientArtifactContract.test.js src/lib/construtor/__tests__/constructorApprovedPreviewDiagnosticReader.test.js` (verde). Validações finais completas (`git diff --name-only origin/main...HEAD`; `git diff --check origin/main...HEAD`; `npm test`; `npm run build`) executadas ao final deste PR. |
